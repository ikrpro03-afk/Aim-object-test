...
-- ============================================================
--  GUI (ЗАГРУЗОЧНЫЙ ЭКРАН + ОСНОВНОЙ)
-- ============================================================
...
--  АНИМАЦИЯ ЗАГРУЗКИ
-- ============================================================
local function animateLoading(loading)
...
local function buildMainGUI()
    ...
    local function createIconButton(icon, col, row, activeColor)
